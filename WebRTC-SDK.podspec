Pod::Spec.new do |spec|
  ...
  spec.homepage = "https://github.com/CaptainTeemo/Specs"
  ...
  spec.source = { :http => "https://github.com/CaptainTeemo/Specs/releases/download/137.7777.79/WebRTC.xcframework.zip" }
